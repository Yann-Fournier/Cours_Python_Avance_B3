...
class Controller:
    ...
    def _operations(self, user_input):
        ...
        if user_input == "1":
            ...
            self.result = self.operator.puissance(operation)
        elif user_input == "6":
            self.result = self.operator.racine_carree(operation)
        elif user_input == "7":
            self.result = self.operator.factorielle(operation)
        elif user_input == "8":
            self.result = self.operator.logarithme(operation)
        elif user_input == "9":
            self.result = self.operator.exponentielle(operation)
